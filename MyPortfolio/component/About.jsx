  ...
  return (
    <div className='h-[90vh] w-screen overflow-x-hidden bg-slate-800 px-24 overflow-hidden'>
      <div className='w-full h-full flex flex-col justify-center items-center md:p-24'> 
        <div className='w-full h-full flex flex-col xl:justify-between items-center xl:flex-row mt-[100%] xl:mt-0 md:mt-[20%] sm:mt-[80%]'>
          <div className=''>
          ...
          <div className=''>
            <Parallax speed={20} tagOuter="figure">
              <div className='about-box p-8 max-w-[500px] rounded-md'>
