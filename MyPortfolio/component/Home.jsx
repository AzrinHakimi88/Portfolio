    ...
    <div className='relative h-[90vh] w-[100vw] z-10 overflow-x-hidden bg-slate-950'>
        ...
        <div className='absolute inset-0 flex'>
          <div className='transparent-bg h-full w-1/2  p-4'>
            <h1 className='mt-8 text-white text-5xl poppins-bold text-center resposive-text-xl'>Hi, I am <span className='blue-gradient'>Azrin Hakimi bin Azizan</span> </h1>
          </div>
          <div className='h-full w-1/2 p-4 flex flex-col justify-center items-center '>
            <h1 className='text-white text-6xl text-center mt-4 mb-2 green-gradient resposive-text-md'>Computer Science</h1>
